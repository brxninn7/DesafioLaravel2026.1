    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    {{-- Menu para visitantes DESLOGADOS --}}
                    <div class="flex gap-4">
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700">Entrar</a>
                        <a href="{{ route('register') }}" class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700">Cadastrar</a>
                    </div>
                @endauth
            </div>
